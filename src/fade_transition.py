    ...
    def fade_in(self, display_surface, fade=False):
        ...
        if fade:
            for alpha in range(255, 0, -5):  # fading from fully opaque (255) to fully transparent (0) in decrements of 5
                ...
                self.display_surface.blit(self.screen_copy, (0,0)) # repeatedly blitting the screen_copy image before the fade surface to get the fading effect for fade in (otherwise it would just be a plain black screen)
